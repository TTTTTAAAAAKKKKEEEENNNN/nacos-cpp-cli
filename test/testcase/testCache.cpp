...
bool testCleanTestenvCacheAndGetTestenv()
{
	...
	LocalConfigInfoProcessor::cleanAllSnapshot();
	LocalConfigInfoProcessor::saveSnapshot("Testenv", "DummyData", "BusinessGrp1", "FrontTenant", "Value for FrontTenant&Testenv");
	LocalConfigInfoProcessor::saveSnapshot("Prodenv", "DummyData", "BusinessGrp1", "FrontTenant", "Value for FrontTenant&Prodenv");
	...
	SHOULD_BE_TRUE(cntPrdFrontEnd == "Value for FrontTenant&Prodenv", "Testenv removed, Check settings for FrontTenant&Prodenv");
...
bool testCleanPrdCacheAndGetPrdenv()
{
	...
	SHOULD_BE_TRUE(cntfrontEndTest == "Value for FrontTenant&Testenv", "Prodenv removed, Check settings for FrontTenant&Testenv");
